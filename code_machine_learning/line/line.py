...
class LINE:
    def __init__(self, graph, embedding_size=8, negative_ratio=5, order='second',) -> object:
        """
    ...
    def train(self, batch_size=1000, epochs=1, initial_epoch=0, verbose=1, times=1):
