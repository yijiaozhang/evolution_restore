...
def get_keys(dic: object, value: object):
    # input current time, output current edges
...
def get_net_data(net_name, net_name_lp, edges):
    ...
    """
    # return edge
    edge_path = "./net_data/lp_svd/" + net_name_lp + "/adj/"
    ...
    time_path = "./net_data/lp_svd/" + net_name_lp + "/edgetime/"
    ...
    # return mat
    mat_path = "./net_data/lp_svd/" + net_name_lp + "/mat/"
...
def test_main():
    ...
    for net_name in net_names:
        ...
        mat_path = "./net_data/lp_svd/" + net_name_lp + "/"
