...
class DeepWalk:
    def __init__(self, graph: object, walk_length: object, num_walks: object, workers: object = 1) -> object:
        """

        :rtype: object
        """
        self.graph = graph
        self.w2v_model = None  # 使用skip-gram model进行向量学习
    ...
    def train(self, embed_size=128, window_size=5, workers=3, iter=5, **kwargs):
        sentences = [list(map(str, sentence)) for sentence in self.sentences]
