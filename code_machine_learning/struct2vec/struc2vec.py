...
class Struc2Vec():
    def __init__(self, graph: object, walk_length: object = 10, num_walks: object = 100, workers: object = 1, verbose: object = 0, stay_prob: object = 0.3,
                 opt1_reduce_len: object = True,
                 opt2_reduce_sim_calc: object = True,
                 opt3_num_layers: object = None,
                 temp_path: object = './temp_struc2vec/',
                 reuse: object = False) -> object:
        """
    ...
    def train(self, embed_size=128, window_size=5, workers=3, iter=5):
        ...
        print(sentences[0])
        sentences = [list(map(str, sentence)) for sentence in sentences]
        print(sentences[0])
